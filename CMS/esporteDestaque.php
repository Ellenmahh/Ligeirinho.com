...
if(isset($_GET['modo'])){
	$modo=$_GET['modo'];
		if($modo=='excluir'){
			$cod=$_GET['codigo'];
			$delete='delete from tblesporte_destaque WHERE id='.$cod;
			//echo $delete;
            mysql_query($delete);
			header('location:esporteDestaque.php');
        ...
        if($modo=='editar'){
            ...
            $sql ="SELECT * from tblesporte_destaque where id=" .$cod;
            ...
            if($modo=='ativo'){
                ...
                $sql = "UPDATE tblesporte_destaque SET exibir = 1 WHERE id=".$cod;
                //echo $sql;
                mysql_query($sql);
                header('location:esporteDestaque.php');
                ...
                $sql="UPDATE tblesporte_destaque SET exibir = 0 WHERE id=".$cod;
                 mysql_query($sql);
                header('location:esporteDestaque.php');
            }
        }
    ...
    if($_POST['btncadastrar']=="Salvar"){
        ...
        if($extensao == 'jpg' || $extensao == 'png'){
            if(move_uploaded_file($_FILES['fleFoto']['tmp_name'], $nome_arquivo)){
                $sql="INSERT INTO tblEsporte_destaque (imagem,nome,preco,descricao) VALUES
        ...
        if($_FILES['fleFoto']['error']==0){
			...
			$uploadfile = $uploaddir . $nome_arq;
             if(move_uploaded_file($_FILES['fleFoto']['tmp_name'], $nome_arquivo)){
            $sql="UPDATE tblEsporte_destaque SET 
            imagem = '".$nome_arquivo."',
            nome = '".$nome."', 
            descricao = '".$descricao."',
            preco = ".$preco."
            ...
            <header>
             ...
             <section id="conteudo">
                 ...
                 <nav>
                    ...
                    <div id="tblUser">
                        <form method="POST" name="frmEsporte" action="esporteDestaque.php" enctype="multipart/form-data" >
                            <div id="exibirDiv">
                                ...
                                <?php
                                $sql="SELECT * FROM tblEsporte_destaque ORDER BY id DESC";
                                ...
                                <table class="tblVisu">
                                   <tr style="background-color:black;">
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                         <a href="esporteDestaque.php?modo=editar&codigo=<?php echo $lista['id']?>">
                                             <img style="height:50px" src="CMS_IMG/edit.png"></a>

                                        <a href="esporteDestaque.php?modo=excluir&codigo=<?php echo $lista['id']?>"> 
                                            <img style="height:50px" src="CMS_IMG/delete.png"></a>
                                        </td>
                                        <td>
                                            <a href="esporteDestaque.php?modo=ativo&codigo=<?php echo $lista['id']?>">
                                               <img src="CMS_IMG/ativo.png" style="height:30px"></a>
                                        
                                            <a href="esporteDestaque.php?modo=inativo&codigo=<?php echo $lista['id']?>">
